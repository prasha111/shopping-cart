...
{new Array(5).fill("").map((some, index)=>{
    return(
        (index<rate)?
            <svg class="w-3 h-3 text-red-400 me-1" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 22 20">
